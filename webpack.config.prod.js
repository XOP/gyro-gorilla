...
export default {
    ...
    module: {
        rules: [
            {
                test: /offline.html$/,
                loader: 'url-loader?limit=1&mimetype=text/html&name=[name].[ext]'
            },

            {
                test: /client.js$/,
                loader: 'url-loader?limit=1&mimetype=text/javascript&name=[name].[ext]!babel-loader'
            },
